...
UblDblMatrix RbfInterpolator::_calcMatrix()
{
...
std::vector<double> RbfInterpolator::_getWeights(double x, double y)
{
...
std::vector<double> RbfInterpolator::_getVals()
{
...
double RbfInterpolator::_correctZ(double z)
{
	return z;
}