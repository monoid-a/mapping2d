...
UblDblMatrix MatrixCalculator::calcMatrix(const std::vector<double>& xs, const std::vector<double>& ys, size_t nx, size_t ny, const TwoPointsFunc& gamma, const MatrixModifFunc& matrix_func, double init_val)
{
